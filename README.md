...
Please review [our security policy](https://github.com/cratespace/sentinel/security/policy) on how to report security vulnerabilities.

## License

Cratespace Sentinel is open-sourced software licensed under the [MIT license](LICENSE.md).
